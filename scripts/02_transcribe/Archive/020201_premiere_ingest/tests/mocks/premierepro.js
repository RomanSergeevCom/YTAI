...
const Constants = {
  ...
  ProjectItemColorLabel: {
    VIOLET: 0, BLUE: 1, GREEN: 2, YELLOW: 3, CERULEAN: 4,
    BROWN: 5, FOREST: 6, IRIS: 7, LAVENDER: 8, MAGENTA: 9,
    MANGO: 10, PURPLE: 11, ROSE: 12, TAN: 13, TEAL: 14
  },
  MarkerColor: {
    GREEN: 0, RED: 1, PURPLE: 2, ORANGE: 3, YELLOW: 4,
    WHITE: 5, BLUE: 6, CYAN: 7
  }
};
