# transcribe_project v2.15 — Спецификация
...
**v2.15:** улучшенное отображение статусов — ровные таблицы, понятный ETA (`~Xm left`), `_trow()` для выравнивания.

**Скрипт:** ~/YTAI/scripts/02_transcribe/transcribe_project_v2.15.py
**Версия:** 2.15
...
## Окружение
    ...
    python ~/YTAI/scripts/02_transcribe/transcribe_project_v2.15.py \
...
### Вариант A: Папка с видео (flat)
    ...
    python transcribe_project_v2.15.py --project "/path/to/Interview" -y
...
### Вариант B: Один видеофайл
    ...
    python transcribe_project_v2.15.py --project "/path/to/C5090.MP4" -y
...
### Вариант C: Папка с подпапками камер (multi-camera)
    python transcribe_project_v2.15.py --project '/Volumes/RYA T7 Black/YTCG Gambling Ru' -y
...
### clip_offsets.json
    ...
    {
      "version": "2.15", "created_at": "2026-01-13T12:22:00Z",
      "clips": [
...
### diarization.json
    ...
    {
      "version": "2.15", "created_at": "2026-01-13T12:30:00Z",
...
**Слова НЕ включены** — доступны в per-clip JSON.
    ...
    {
      "version": "2.15", "created_at": "2026-01-13T12:50:47Z", "project": "Interview",
...
### Terminal Output
    ...
    ========================================================
      YTAI Transcribe v2.15                         (white on cyan BG)
    --------------------------------------------------------
      Project:    Interview
...
### Полная цепочка обработки
    ...
    [Съёмка] -> Папка с клипами (C5090.MP4, C5091.MP4, ...)
                    ...
                    v
    +----------------------------------------------------------+
    |  Stage 02: transcribe_project v2.15  (ЭТОТ СКРИПТ)      |
    |                                                          |
