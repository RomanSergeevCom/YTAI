...
WORDS = PROJECT / '00_Setup/05_Review/YTCH12_v4.words.json'
STATE = M / 'notes_sheet.json'
PARENT = '1NQTnpDbPMhBxc8-872xWMULS5d9AC8IY'   # YTCH S3/YTCH12_Sveta
TITLE = 'YTCH12 Review Notes'
TAB = 'Notes'
HDR = ['ID', 'When', 'Sequence', 'TC', 'v4 TC', 'Chapter', 'Transcript ±12s',
       'Роман — комментарий', 'Claude — подбор', 'Status', 'Frame']
# рендер v4 лежит на T9-Black (на T7-Beige нет места) — для кадров нот нужен смонтированный T9
RENDER = Path('/Volumes/T9-Black-RYA/YTCH/YTCH12_Sveta/03_Exports/YTCH12_Sveta_montage_1.mp4')
SHOTS_REMOTE = 'gdrive:YTCH12_review_frames'
