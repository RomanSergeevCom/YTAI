...
def selftest():
    ...
    assert render_block('do', ['  перенести   вход фонда ']) == ['✅ СДЕЛАТЬ · перенести вход фонда']
    assert render_block('do', []) == [] and render_block('do', None) == [] and render_block('do', ['', ' ']) == []

    # текст + продолжение
    assert render_block('do', ['первое', 'второе']) == ['✅ СДЕЛАТЬ · первое', IND + 'второе']
    ...
    assert got == ['✅ СДЕЛАТЬ · вернуть реплики', IND2 + FIG + '1:05  ▸ первая', IND2 + '12:30  ▸ вторая',
    ...
    assert got == ['✅ СДЕЛАТЬ · вернуть реплики', IND2 + '▸ первая', IND2 + '• вторая', IND2 + FIG + '7:05  ▸ третья'], got
