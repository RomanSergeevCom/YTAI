...
STRINGS = {
    ...
    'c2.tz_hdr': {'ru': ['№', '⏱ TC', '', 'Говорит', 'Комментарии Романа', '✅',
                         'Описание ошибки', 'Материал / ссылки', 'Как надо'],
                  'en': ['#', '⏱ TC', '', 'Said', "Roman's comments", '✅',
                         'What is wrong', 'Material / links', 'How it should be']},
