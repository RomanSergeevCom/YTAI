...
STRINGS = {
    ...
    # Роман 22.09.2026: «✅ — ощущение, что это знак сделано». Блок «Как надо» ведёт треугольник.
    'core.lbl_do': {'ru': '▶ СДЕЛАТЬ', 'en': '▶ DO'},
    # Метка того же блока до 22.09.2026. Нужна живой: прошлые круги (pravki_prev_*.json) собраны с ней,
    # и обратная связь «что стало с прошлым ТЗ» разбирает их текст по меткам. Не печатается нигде.
    'core.lbl_do_legacy': {'ru': '✅ СДЕЛАТЬ', 'en': '✅ DO'},
