...
def selftest():
    ...
    # 3) у незакрытого пункта вырезан блок «✅ СДЕЛАТЬ» из «Как надо»
    out = broken(lambda d: _replace(_find_row(d, lambda c: c[0].startswith('ТЗ-11 · v4')), B.C_FIX, '✅ СДЕЛАТЬ · укоротить плашку\n', ''))
    assert 'ТЗ-11 · прошлое ТЗ: в колонке «Как надо» нет блока «✅ СДЕЛАТЬ ·»' in out and 'расхождение с' in out, out
