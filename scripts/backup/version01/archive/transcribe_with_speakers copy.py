...
# Run on MPS (Apple Silicon) if available
        ...
        # Load WAV into memory to avoid torchcodec/ffmpeg decoding issues.
        # This works for .wav inputs and bypasses torchcodec entirely.
        import numpy as np
        import torch
        ...
        audio = audio.reshape(-1, num_channels).T  # (channels, time)
        audio_in_memory = {
