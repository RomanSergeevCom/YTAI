...
if ONLY in ('all', 'graphics'):
    ...
    for name, txt in (('mapfull_burma.png', 'V3 · Мьянма: Могок + Монг Су на реальной карте @17:27 (замена рисованной схемы 052).'),
                      ('mapfull_belt.png', 'V3 · «Рубиновый пояс»: все месторождения из озвучки на реальной карте @19:30 (замена таблицы 053).'),
