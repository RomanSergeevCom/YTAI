...
#: ⚠️ Своей копии выражения здесь БОЛЬШЕ НЕТ — берём из contract.py. Одна и та
#: же мысль, записанная в двух файлах, однажды разойдётся, и это ровно та беда,
#: которой обязан этот этап (три копии рецепта стоили комплекта YTCH).
SPANNER_RE = K.SPANNER_RE
