...
|---------|------|------|-------------|-----------|-------------------|-------------|--------|
| 2-01-01 | 01 | 0 | AUD-01 | unit | `pytest tests/test_0104.py::test_audio_extraction_scene_path -x` | ❌ W0 | ⬜ pending |
| 2-01-02 | 01 | 0 | AUD-02 | unit | `pytest tests/test_0104.py::test_scene_concat -x` | ❌ W0 | ⬜ pending |
| 2-01-03 | 01 | 0 | AUD-03 | unit | `pytest tests/test_0104.py::test_candidate_selection -x` | ❌ W0 | ⬜ pending |
| 2-01-04 | 01 | 0 | AUD-04 | unit | `pytest tests/test_0104.py::test_tx01_trim -x` | ❌ W0 | ⬜ pending |
| 2-01-05 | 01 | 0 | AUD-05 | unit | `pytest tests/test_0104.py::test_tx02_trim -x` | ❌ W0 | ⬜ pending |
| 2-01-06 | 01 | 1 | AUD-06 | manual | manual on YTCR_1_Arty_Dzis apartment scene | manual | ⬜ pending |
| 2-01-07 | 01 | 0 | AUD-07 | unit | `pytest tests/test_0104.py::test_ingest_tracks -x` | ❌ W0 | ⬜ pending |
